# Анимация моделирования задачи "Обедающие философы"
#
# Данный скрипт создаёт анимацию изменения маркировки сети Петри
# во времени для классической модели обедающих философов.
# Анимация наглядно демонстрирует возникновение deadlock.
